...
private const val ROUTE = "chinese_character_stroke_show"

fun NavController.navigateToChineseCharacterStrokeShowScreen() {
    this.navigate(ROUTE)
}

fun NavGraphBuilder.chineseCharacterStrokeShowScreen(
    onBackClick: () -> Unit,
) {
    composable(ROUTE) {
