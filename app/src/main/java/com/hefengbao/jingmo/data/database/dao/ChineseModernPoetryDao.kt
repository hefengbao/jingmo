...
interface ChineseModernPoetryDao {
    ...
    @Query("select p.* from chinese_modernpoetry p join chinese_modernpoetry_fts on chinese_modernpoetry_fts.rowid = p.id where chinese_modernpoetry_fts match :query")
